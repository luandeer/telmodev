...
export function SiteHeader() {
  return (
    <header className=" fixed top-0 z-40 w-full border-b bg-white dark:bg-transparent">
      <div className="container flex h-12 items-center space-x-4 text-gray-900 max-sm:px-3 sm:justify-between sm:space-x-0">
